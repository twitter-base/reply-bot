...
RegExp.escape = function escape(string) { // https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide/Regular_Expressions#Escaping
                                                ...
                                                if (urls) {
                                                  ...
                                                  urls.forEach(urlValue => {
                                                      reply_text = reply_text
                                                                    .replaceAll(
                                                                      new RegExp(urlValue.url.escape(), 'ig'),
