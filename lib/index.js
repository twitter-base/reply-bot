...
import _emojiRegex from "emoji-regex/text.js";
...
const // there are more const function variables to follow,
  ...
  emojiCount = text => emojiRegex.exec(text).count,
  // isEmojiRidden = (text) => {
  //   const characterCount = runes(text).count;
  //   const emojiCount = emojiCount(text);
  //   const spaceCount =
  //   runes ?
  // },
  start = async () => {
